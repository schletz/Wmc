...
<template>
    ...
    <p>
        Crated at {{ new Date(newsData.created).toLocaleString('de-AT', { year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit' }) }} by {{ newsData.authorFirstname }}
